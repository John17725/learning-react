...
export default function Form() {
    ...
    const storage = async (e) => {
        ...
        const response = await axios.post('http://localhost:4000/api/post', NewEmployee);
        console.log(response);
    }

    return (
        <div className="leading-loose">
            <form onSubmit={storage} className="max-w-4xl m-4 p-10 bg-white rounded shadow-xl place-content-center">
